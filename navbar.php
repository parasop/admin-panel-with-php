<html>
  ...
  <a href="https://flowbite.com/" class="flex items-center">
      <img src="https://geetanjaligroupofcolleges.in/wp-content/uploads/2020/02/cropped-Geetanjali-College-e1582550228292-10.png" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo">
      <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Geetanjali</span>
  </a>
  <div class="flex md:order-2">
      ...
      <button type="button" class="ml-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Register</button>
      </div>
